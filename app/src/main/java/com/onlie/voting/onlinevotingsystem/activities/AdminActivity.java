...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    Map<String, Object> map = (Map<String, Object>) ds.getValue();
                    Object vote = map.get("RISING SUN");
                    int vValue = (int) Integer.parseInt(String.valueOf(vote));
                    dsum += vValue;
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    Map<String, Object> map = (Map<String, Object>) ds.getValue();
                    Object vote = map.get("TWO LEAVES");
                    int vValue = (int) Integer.parseInt(String.valueOf(vote));
                    msum += vValue;
    ...
    public void individualVote(View view) {
        startActivity(new Intent(AdminActivity.this, IndividualVotesActivity.class));
    }
